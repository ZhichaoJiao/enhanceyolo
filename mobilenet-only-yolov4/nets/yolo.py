...
class Densenet(nn.Module):
    ...
    def forward(self, x):
        ...
        feature_maps.append(x)
        return feature_maps[0], feature_maps[1], feature_maps[2], feature_maps[3], feature_maps[4]
...
class YoloBody(nn.Module):
    def __init__(self, anchors_mask, num_classes=1, backbone="mobilenetv3", pretrained=False):
        ...
        if backbone == "mobilenetv1":
            ...
            #   52,52,512；26,26,1024；13,13,2048
            #---------------------------------------------------#
            self.backbone = EfficientNet(phi=1, load_weights = True)
            in_filters      = [40, 112, 320]
        else:
